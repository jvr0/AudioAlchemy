...
if user_input == password:
    ...
    def statistics():
        ...
        tab1, tab2, tab3, tab4, tab5 = st.tabs(['Top 10 artistas y sellos', 'Condición de los items', 'Posibilidad de aceptar oferta', 'Recuento items a la venta', 'Recuento items vendidos'])
